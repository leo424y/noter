...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { base: @phone.base, call: @phone.call, name: @phone.name, phone: @phone.phone, status: @phone.status } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { base: @phone.base, call: @phone.call, name: @phone.name, phone: @phone.phone, status: @phone.status } }
